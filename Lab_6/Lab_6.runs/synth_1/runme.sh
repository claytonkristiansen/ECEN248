...
HD_PWD='C:/Users/Clayt/repos/ECEN248/Lab_6/Lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_behavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder_behavioral.tcl
