...
HD_PWD='C:/Users/Clayt/repos/ECEN248/Lab_6/Lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_behavioral.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder_behavioral.tcl -notrace
