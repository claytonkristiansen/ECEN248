`timescale 1ns / 1ps
`define STRLEN 32
`define CLOCK_PERIOD 20         //Delay on Carry bit is 20ns and it is unstable until that point. Any clock speed under 20 ns will result in the possibility of storing an unstable Carry value in the Carry register
